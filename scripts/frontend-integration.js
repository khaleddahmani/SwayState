 ...
 * This file demonstrates how to integrate Swaystate with a web frontend
 */

// For React/Vue/Angular applications
export class SwaystateClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SwaystateClient(provider, contractAddress);
